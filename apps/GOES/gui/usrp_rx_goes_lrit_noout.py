...
# Title: USRP LRIT Receiver - check signal quality
# Author: Martin Blaho
# Description: GOES - LRIT receive and check signal quality
# Generated: Wed Jan 12 23:57:24 2011
##################################################
...
class usrp_rx_goes_lrit_noout(grc_wxgui.top_block_gui):
...
if __name__ == '__main__':
	...
	tb = usrp_rx_goes_lrit_noout(deframer_insync_frames=options.deframer_insync_frames, viterbi_insync_frames=options.viterbi_insync_frames, deframer_outsync_frames=options.deframer_outsync_frames, viterbi_outsync_frames=options.viterbi_outsync_frames, viterbi_sync_threshold=options.viterbi_sync_threshold, satellite=options.satellite, freq=options.freq, gain=options.gain, decim=options.decim, side=options.side, pll_alpha=options.pll_alpha, symb_rate=options.symb_rate, clock_alpha=options.clock_alpha)
	tb.Run(True)
