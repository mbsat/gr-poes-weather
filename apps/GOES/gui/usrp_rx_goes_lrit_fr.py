...
# Author: Martin Blaho
# Description: GOES - LRIT receive and decode signal to CADU
# Generated: Wed Jan 12 23:57:25 2011
##################################################
...
class usrp_rx_goes_lrit_fr(grc_wxgui.top_block_gui):

	def __init__(self, deframer_insync_frames=2, viterbi_insync_frames=5, deframer_outsync_frames=5, viterbi_outsync_frames=20, viterbi_sync_check=True, viterbi_sync_threshold=0.1, deframer_sync_check=True, frames_file=os.environ['HOME'] + '/GOES-LRIT_cadu_frames.cadu', clock_alpha=0.005, symb_rate=293883, pll_alpha=0.005, satellite='GOES-LRIT', freq=1691.02e6, gain=23, decim=108, side="A"):
		...
		self.gr_file_sink_0_1 = gr.file_sink(gr.sizeof_char*1, frames_file)
		...
		self.connect((self.poesweather_metop_cadu_deframer_0, 0), (self.gr_file_sink_0_1, 0))
...
if __name__ == '__main__':
	...
	tb = usrp_rx_goes_lrit_fr(deframer_insync_frames=options.deframer_insync_frames, viterbi_insync_frames=options.viterbi_insync_frames, deframer_outsync_frames=options.deframer_outsync_frames, viterbi_outsync_frames=options.viterbi_outsync_frames, viterbi_sync_threshold=options.viterbi_sync_threshold, frames_file=options.frames_file, clock_alpha=options.clock_alpha, symb_rate=options.symb_rate, pll_alpha=options.pll_alpha, satellite=options.satellite, freq=options.freq, gain=options.gain, decim=options.decim, side=options.side)
	tb.Run(True)
