...
# Title: USRP NOAA HRPT Receiver
# Author: POES Weather Ltd
# Description: NOAA HRPT Receiver
# Generated: Fri Jan  7 13:22:06 2011
##################################################
...
class usrp_rx_noaa_bb_hrpt(grc_wxgui.top_block_gui):

	def __init__(self, satellite='NOAA-XX', baseband_file=os.environ['HOME'] + '/NOAA-XX.dat', frames_file=os.environ['HOME'] + '/NOAA-XX.hrpt', side="A", freq=1698e6, decim=32, sync_check=False, gain=25):
...
if __name__ == '__main__':
	...
	tb = usrp_rx_noaa_bb_hrpt(satellite=options.satellite, baseband_file=options.baseband_file, frames_file=options.frames_file, side=options.side, freq=options.freq, decim=options.decim, sync_check=options.sync_check, gain=options.gain)
	tb.Run(True)
