...
# Generated: Fri Jan  7 13:43:08 2011
##################################################
...
class noaa_hrpt_bb_to_frames(grc_wxgui.top_block_gui):
...
if __name__ == '__main__':
	...
	tb = noaa_hrpt_bb_to_frames(frames_file=options.frames_file, decim=options.decim, satellite=options.satellite, baseband_file=options.baseband_file, sync_check=options.sync_check)
	tb.Run(True)
