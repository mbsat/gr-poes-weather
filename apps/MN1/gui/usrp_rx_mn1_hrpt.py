...
# Generated: Mon Dec 20 15:25:32 2010
##################################################
...
class usrp_rx_mn1_hrpt(grc_wxgui.top_block_gui):
...
if __name__ == '__main__':
	...
	tb = usrp_rx_mn1_hrpt(side=options.side, gain=options.gain, decim=options.decim, sync_check=options.sync_check, satellite=options.satellite, frames_file=options.frames_file, freq=options.freq)
	tb.Run(True)
