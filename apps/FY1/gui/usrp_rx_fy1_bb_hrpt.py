...
class usrp_rx_fy1_bb_hrpt(grc_wxgui.top_block_gui):
	...
	def __init__(self, side="A", gain=35, sync_check=False, decim=16, satellite='FENGYUN-1D', frames_file=os.environ['HOME'] + '/FENGYUN-1D.hrpt', baseband_file=os.environ['HOME'] + '/FENGYUN-1D.dat', freq=1700.5e6):
		...
		self.gr_file_sink_0 = gr.file_sink(gr.sizeof_short*1, "/home/jerry/feng-yun-bb.dat")
		self.gr_file_sink_0.set_unbuffered(False)
		self.gr_file_sink_0_0 = gr.file_sink(gr.sizeof_short*1, "/home/jerry/feng-yun-frames.hrpt")
...
if __name__ == '__main__':
	...
	tb = usrp_rx_fy1_bb_hrpt(side=options.side, gain=options.gain, sync_check=options.sync_check, decim=options.decim, satellite=options.satellite, frames_file=options.frames_file, baseband_file=options.baseband_file, freq=options.freq)
	tb.Run(True)
